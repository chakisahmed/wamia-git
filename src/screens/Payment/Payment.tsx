            ...
            >
                <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                    ...
                    <View style={{flexDirection:'row',alignItems:'center',gap:5}}>
                        ...
                        <Text style={[FONTS.fontMedium,{fontSize:13,color:colors.title}]}>{t('payment')}</Text>
                    </View>
                </View>
            </View>
            <ScrollView contentContainerStyle={{flexGrow:1}}>
                <View style={[GlobalStyleSheet.container, { marginTop:15,backgroundColor:theme.dark ? 'rgba(255,255,255,.1)':colors.card }]}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',borderBottomWidth:1,marginHorizontal:-15,paddingHorizontal:15,paddingBottom:15,borderBottomColor:COLORS.primaryLight }}>
                        <Text style={{ ...FONTS.fontMedium, fontSize: 18, color: colors.title }}>{t('credit_debit_card')}</Text>
                        <TouchableOpacity
                            style={{
                                flexDirection: 'row',
                                alignItems: 'center',
                        ...
                        >
                            <Image
                                ...
                                source={IMAGES.plus}
                            />
                            <Text style={{ ...FONTS.fontMedium, fontSize: 13, color:COLORS.primary }}>{t('add_card')}</Text>
                        </TouchableOpacity>
                    </View>
