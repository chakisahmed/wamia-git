...
import { Address, BillingAddress } from '@/api/cartApi';
...
const DeliveryAddress = ({ navigation }: DeliveryAddressScreenProps) => {
    ...
    const cart = useSelector((state: RootState) => state.cart.details);
                                                        ...
                                                        <TouchableOpacity
                                                            ...
                                                            onPress={() => {
                                                                if (option === "Set as default") {
                                                                    ...
                                                                    removeAddress(token,data.id).then((res) => {
                                                                        setAdresses((add) => {
            ...
            <View style={[GlobalStyleSheet.container, { paddingHorizontal: 0, paddingBottom: 0 }]}>
                ...
                >
                    ...
                    <Button title={t("continue")}
                        ...
                        text={theme.dark ? COLORS.darkTitle : COLORS.title}
                        onPress={() => {
                            if (adresses.shipping && adresses.billing) {
                                navigation.navigate('Checkout', { cart, addresses: adresses });
                            } else {
                                alert(t("select_shipping_billing_addresses"));
                            }
                        }}
                    />
